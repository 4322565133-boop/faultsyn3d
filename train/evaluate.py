...
from train.dataset_thebe import ThebeXYC, THEBE_CATEGORIES          # noqa: E402
...
def main():
    ...
    p.add_argument("--thebe", action="store_true", help="data/thebe_cubes test grid (Thebe field data)")
    ...
    cats = THEBE_CATEGORIES if a.thebe else (WU_CATEGORIES if a.wu else (LEGACY_CATEGORIES if a.legacy else CATEGORIES))
    te = ThebeXYC("test") if a.thebe else (WuXYC("test") if a.wu else (LegacyXYC("test") if a.legacy else FaultVolumes(a.data, "test")))
    ...
    short = {"en_echelon": "enech", "horsetail": "horse", "negative_flower": "negfl",
             ...
             "fault_none": "f_none", "fault_sparse": "f_spar", "fault_dense": "f_dens"}
